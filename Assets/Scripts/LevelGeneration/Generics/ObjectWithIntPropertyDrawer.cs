...
public class ObjectWithIntPropertyDrawer<T> : PropertyDrawer
{
...
[CustomPropertyDrawer(typeof(StringWithInt))]
public class StringWithIntPropertyDrawer : ObjectWithIntPropertyDrawer<string>
{
    // nothing needed here
}
